...
import { createSelectableCollection, createSelectableItem, createListState } from './3D6FM2PJ.js';
...
import { createContext, useContext, createSignal, splitProps, createEffect, on, onCleanup, Show, createUniqueId, createMemo, mergeProps as mergeProps$1 } from 'solid-js';
...
function TabsIndicator(props) {
  ...
  const computeStyle = () => {
    ...
    const styleObj = {
      ...
      width: void 0,
      height: void 0,
      transition: style() == null ? "none" : void 0
    };
