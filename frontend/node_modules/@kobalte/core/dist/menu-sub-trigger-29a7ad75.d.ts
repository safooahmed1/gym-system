...
import { ParentProps, JSX, ValidComponent, Accessor, ComponentProps } from 'solid-js';
import { ElementOf, PolymorphicProps } from './polymorphic/index.js';
import { Portal } from 'solid-js/web';
import { Polygon, Orientation } from '@kobalte/utils';
...
import { F as FocusStrategy, L as ListState } from './create-list-state-d9a0f1f2.js';
...
interface MenuProps extends ParentProps<MenuOptions> {
}
/**
 * Container for menu items and nested menu, provide context for its children.
 */
declare function Menu(props: MenuProps): solid_js.JSX.Element;
...
declare const MenuContext: solid_js.Context<MenuContextValue | undefined>;
declare function useOptionalMenuContext(): MenuContextValue | undefined;
...
interface MenuRootProps extends ParentProps<MenuRootOptions> {
}
/**
 * Root component for a menu, provide context for its children.
 * Used to build dropdown menu, context menu and menubar.
 */
declare function MenuRoot(props: MenuRootProps): solid_js.JSX.Element;
...
export { MenuRadioGroupOptions as $, MenuGroupLabelRenderProps as A, MenuGroupOptions as B, MenuGroupProps as C, MenuGroupRenderProps as D, MenuIconCommonProps as E, MenuIconOptions as F, MenuIconProps as G, MenuIconRenderProps as H, MenuItemCommonProps as I, MenuItemDescriptionCommonProps as J, MenuItemDescriptionOptions as K, MenuItemDescriptionProps as L, MenuCheckboxItem as M, MenuItemDescriptionRenderProps as N, MenuItemIndicatorCommonProps as O, MenuItemIndicatorOptions as P, MenuItemIndicatorProps as Q, MenuItemIndicatorRenderProps as R, MenuItemLabelCommonProps as S, MenuItemLabelOptions as T, MenuItemLabelProps as U, MenuItemLabelRenderProps as V, MenuItemOptions as W, MenuItemProps as X, MenuItemRenderProps as Y, MenuPortalProps as Z, MenuRadioGroupCommonProps as _, MenuContent as a, MenuRadioGroupProps as a0, MenuRadioGroupRenderProps as a1, MenuRadioItemCommonProps as a2, MenuRadioItemOptions as a3, MenuRadioItemRenderProps as a4, MenuRadioItemProps as a5, MenuSubContentCommonProps as a6, MenuSubContentOptions as a7, MenuSubContentProps as a8, MenuSubContentRenderProps as a9, MenuSubOptions as aa, MenuSubProps as ab, MenuSubTriggerCommonProps as ac, MenuSubTriggerOptions as ad, MenuSubTriggerProps as ae, MenuSubTriggerRenderProps as af, MenuRootOptions as ag, MenuDataSet as ah, MenuOptions as ai, MenuProps as aj, Menu as ak, MenuContextValue as al, MenuContext as am, useOptionalMenuContext as an, useMenuContext as ao, MenuRootProps as ap, MenuRoot as aq, MenuGroup as b, MenuGroupLabel as c, MenuIcon as d, MenuItem as e, MenuItemDescription as f, MenuItemIndicator as g, MenuItemLabel as h, MenuPortal as i, MenuRadioGroup as j, MenuRadioItem as k, MenuSub as l, MenuSubContent as m, MenuSubTrigger as n, MenuCheckboxItemCommonProps as o, MenuCheckboxItemOptions as p, MenuCheckboxItemProps as q, MenuCheckboxItemRenderProps as r, MenuContentCommonProps as s, MenuContentOptions as t, MenuContentProps as u, MenuContentRenderProps as v, MenuGroupCommonProps as w, MenuGroupLabelCommonProps as x, MenuGroupLabelOptions as y, MenuGroupLabelProps as z };
