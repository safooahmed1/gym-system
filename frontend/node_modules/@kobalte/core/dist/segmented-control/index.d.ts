...
declare const SegmentedControl: (<T extends solid_js.ValidComponent = "div">(props: PolymorphicProps<T, SegmentedControlRootProps>) => solid_js.JSX.Element) & {
    ...
    Item: <T extends solid_js.ValidComponent = "div">(props: PolymorphicProps<T, SegmentedControlItemProps<T>>) => solid_js.JSX.Element;
    ...
    ItemInput: <T extends solid_js.ValidComponent = "input">(props: PolymorphicProps<T, SegmentedControlItemInputProps<T>>) => solid_js.JSX.Element;
